    ...
    return (
        <>
            <div
                ...
                className="group -ml-2 flex shrink-0 place-content-center relative border-4 border-white rounded-full bg-gray-400 cursor-pointer"
            >
                ...
                <Image width={AVATAR_SIZE} height={AVATAR_SIZE} src={src} alt={name} className="size-full rounded-full" />
            </div>
        </>
    )
}